...
<htmL>
<title>
Student Fee List- Abhyas Academy Ellenabad
</title>
...
<a href="index.php"><img src="images/logo.jpg" style="margin-top:20px;margin-left:30px;"></a>
</div>
...
<div id="time"></div>
  ...
  <tr style="color:white;background-color:#643">
  <th>SR. No.</th><th>ID</th><th>Name</th><th>Father Name</th><th>Mother Name</th><th>DOB</th><th>Gender</th><th>City</th><th>Address</th><th>Course</th><th>Mobile</th><th>Aadhaar No.</th><th>Marital Status</th><th>Qulification</th><th>Course Fee</th><th>Received Fee</th><th>Remaning Fee</th>
  </tr>
  <?php
			...
			while($row=$result->fetch_assoc())
			{
				...
				$totalRecvd=$row["rfee"];
				$recvd_fee0=$recvd_fee0+$totalRecvd;
				#recvd_fee0 calculate
				?>
			 ...
			 <td><?php echo $row["course"];?></td><td><?php echo $row["mobile"];?></td><td><?php echo $row["aadhaar"];?></td>
			 <td><?php echo $row["mStatus"];?></td><td><?php echo $row["qulification"];?></td>
			 <td><?php echo $row["tfee"];?></td>
			 <td><?php echo $row["rfee"];?></td>
			 <td>
			              <?php 						  
			             $diff=$row["tfee"]-$row["rfee"];
						 if($diff==0)
						 {
							 echo "<b style='color:red'>NILL</b>";
						 }
						 else{
                                    echo $diff;							 
						     }
  ...
  <ul class="list-group">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					 ...
					 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					  <b>Total Fee Received:</b> <?php echo $recvd_fee0;?>
					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					  <b>Total Remaning Fee:</b> <?php echo $diff_fee=$total_fee0-$recvd_fee0;?>
				</li>
	  </ul>
  </div><!-------------container close --------------------->
</body>
